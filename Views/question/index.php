    ...
    <tbody>
        ...
        <?php foreach ($questions as $key => $question) :
            ...
            <tr class="<?php echo $rowClass; ?>">
                ...
                <td class="icone"><svg class='svgClickable' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                ...
                <td class="icone"><svg class='svgClickable' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
