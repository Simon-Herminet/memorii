...
<?php if (!empty($questions)) : ?>
    <table>
        ...
        <tbody>
            <!-- Boucle pour parcourir les questions -->

            <?php foreach ($questions as $key => $question) :
                $rowClass = ($key % 2 == 0) ? 'impair' : 'pair'; ?> <!-- Condition pour alterner les couleurs -->
                <tr class="<?php echo $rowClass; ?>">
                    <td>
                        <p><?php echo $question['question_question']; ?></p>

                    <td>
                        <p><?php echo $question['reponse_question']; ?></p>
                    <td class="icone update">
                        <a href="index.php?controller=question&action=formUpdate&id=<?php echo $question['id_question']; ?>" class="update-question-link">
                    ...
                    <td class="icone delete">
                        <a href="index.php?controller=question&action=deleteQuestion&id=<?php echo $question['id_question']; ?>" class="delete-question-link">
